...
const SeriesDetails = (props) => {
    ...
    return (
        ...
        <Header />
            ...
            <div className="hero sr-single-hero sr-single" style={{ background: `url('${movie.thumb}') center/cover no-repeat` }}>
                    ...
                    <div className="row ipad-width2">
                        ...
                        <div className="col-md-8 col-sm-12 col-xs-12">
                            <div className="movie-single-ct main-content">
                                <h1 className="bd-hd">{movie.name} <span> {movie.year} - {movie.endYear}</span></h1>
                                                ...
                                                <div className="row">
                                                    <div className="col-md-8 col-sm-12 col-xs-12">
                                                        ...
                                                        <div className="mvsingle-item ov-item">
                                                            ...
                                                            <div className="vd-it">
                                                                <img className="vd-img" src="images/uploads/image7.jpg" alt="" />
